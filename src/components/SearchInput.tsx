...
const SearchInput = ({ products }: { products: Product[] }) => {
  ...
  return (
    <div className="relative w-full hidden sm:inline-flex flex-1 h-10 text-base items-center gap-2 justify-between">
      {/* Search Icon */}
      ...
      <input
        ...
        className="flex-1 h-full outline-none bg-opacity-95 placeholder:text-lightText border-[1px] border-accent/30 rounded-lg pl-8 pr-28"
